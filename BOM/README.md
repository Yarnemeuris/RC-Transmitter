...
These are the included BOMs:
- Full: Every component needed for a basic setup. (1 Main PCB and 2 RF PCBs)
- Simplified: All the parts from LCSC condensed into one item.
